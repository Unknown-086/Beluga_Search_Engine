...
file_path = os.path.join('../..', 'data', 'ModifiedDatasets', 'ModifiedReddit_database11.csv')
...
output_file = os.path.join('../..', 'data', 'FilteredDatasets', 'ModifiedReddit_database11_Non_English.csv')
