...
file_path = os.path.join('..', 'data', 'ModifiedDatasets', 'ModifiedReddit_database9.csv')
...
output_file = os.path.join('..', 'data', 'ModifiedDatasets', 'ModifiedReddit_database9_WithoutDocID.csv')
