...
file_path = os.path.join('../..', 'data', 'ModifiedDatasets', 'ModifiedGlobalNewsDataset12.csv')
df = pd.read_csv(file_path)

# Specify the column to be deleted
column_to_delete = 'source_id'  # Replace 'column_name' with the actual column name
...
output_file = os.path.join('../..', 'data', 'ModifiedDatasets', 'ModifiedGlobalNewsDataset13.csv')
