...
file_path = os.path.join('..', 'data', 'FilteredDatasets', 'FilteredRecord3.csv')
df = pd.read_csv(file_path)

# Specify the range of rows and the column name
start_row = 3  # Replace with the starting row index (inclusive)
end_row = 7   # Replace with the ending row index (exclusive)
