...
file_path = os.path.join('../../..', 'data', 'FilteredDatasets', 'ModifiedGlobalNewsDataset13_Non_English.csv')
df = pd.read_csv(file_path)

# Specify the range of rows and the column name
start_row = 0  # Replace with the starting row index (inclusive)
end_row = 100   # Replace with the ending row index (exclusive)
...
output_path = os.path.join('../../..', 'data', 'FilteredDatasets', 'ModifiedGlobalNewsDataset13_Non_English_100.csv')
