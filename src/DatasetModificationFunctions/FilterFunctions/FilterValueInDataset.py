...
file_path = os.path.join('../../..', 'data', 'FilteredDatasets', 'ModifiedGlobalNewsDataset13_English_Language.csv')
...
output_file = os.path.join('../../..', 'data', 'FilteredDatasets', 'ModifiedGlobalNewsDataset13_Language_English.csv')
