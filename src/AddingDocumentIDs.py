...
file_path = os.path.join('..', 'data', 'Datasets', 'GlobalNewsDataset.csv')
df = pd.read_csv(file_path)

# Specify the starting value for numbering
start_value = 100_000  # Change this to your desired start value
...
output_file = os.path.join('..', 'data', 'ModifiedDatasets', 'ModifiedGlobalNewsDatasetWithNumbering.csv')
