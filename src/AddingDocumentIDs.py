...
file_path = os.path.join('..', 'data', 'Datasets', 'news-week-17aug24.csv')
df = pd.read_csv(file_path)

# Specify the starting value for numbering
start_value = 600_000  # Change this to your desired start value
...
output_file = os.path.join('..', 'data', 'ModifiedDatasets', 'ModifiedNews-week-17aug1.csv')
